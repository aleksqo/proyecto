                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-offset-4">
                            <div class="login_title">
                                ...
                                <p>Inicie sesión en su cuenta para descubrir todas las funciones excelentes en esta pagina.</p>
                            </div>
                            <form class="login_form row" method="POST" action="login">
                            {{ csrf_field()}}
                                <div class="col-lg-12 form-group {{ $errors->has('email') ? 'has-error' : ''}}">
                                    <input class="form-control" type="email" name="email" placeholder="email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
                                    {!! $errors->first('email','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="col-lg-12 form-group  {{ $errors->has('password') ? 'has-error' : ''}}">
                                    <input class="form-control" type="password" name="password" value="{{ old('email')}}" placeholder="Contraseña" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}" required="">
                                    {!! $errors->first('password','<span class="help-block">:message</span>') !!}
                                </div>
                                <div class="col-lg-12 form-group>"
                                    <div class="creat_account">
                                        <input type="checkbox" id="f-option" name="selector">
                                        <label for="f-option">Mantenerme conectado </label>
                                        <div class="check"></div>
                                    </div>
                                    <p>No tienes una cuenta? <a href="registro">Click Aqui</a></p>
                                </div>
                                <div class="col-lg-12 form-group">
                                    <button type="submit" value="submit" class="btn btn-danger">Entrar</button>
